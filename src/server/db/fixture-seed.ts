...
export function createDemoWorld(workspaceId = DEMO_MERCHANT_ID, capabilities = capabilityStatus()): DemoWorld {
  ...
  const customers = [
    ...
    { id: "20000000-0000-4000-8000-000000000002", type: "business" as const, displayName: "City Interiors", email: "priya@atelierworks.example", company: "City Interiors" },
